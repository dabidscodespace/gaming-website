  ...
  return (
    <div>
      <Marquee autoFill={true} speed={50} gradient={false}>
        <div className="flex">
          <div className="flex gap-2 items-center bg-orange-50 dark:bg-gray-800 px-4 py-2 rounded-lg border border-orange-200 dark:border-orange-600 min-w-max ml-3">
            <svg
